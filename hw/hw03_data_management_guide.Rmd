...
4. Use the `select` function from `dplyr` package to select the variables from your codebook (**HW02**).  
...
6. Select only the variables that you want to keep, so you only have the version of the variables that you want in your data frame.
...
```{r, eval=FALSE}
save(clean, file="~/R/spring2020/data/myaddhealth_clean.Rdata")
```
