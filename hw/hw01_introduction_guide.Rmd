...
* Rename the template file to `hw01_username` ( i.e. `hw01_jrico` ) 
...
4. Write a reflection in your **Learning Journal** on metacognition and your test results. Were you surprised by the results? 


### Habits for Success

5.  Watch this video (21min) on **Hidden Key to Understanding and Overcoming Procrastination**, https://mcgraw.princeton.edu/node/2641 , and write **one** observation that really made you think about yourself.  
